        ...
        >
          <div className="scrollBox">
            <ul className="scrollList">
              <li>
                국립암센터(국가암데이터센터) K-CORE 회원 이용약관                <ul>
                  <li>
                    제1조 (목적)
                    <ul>
                      <li>
                  ...
                  <li>
                    제2조 (약관의 명시와 개정)                    <ul>
                      ...
                      <li>
                      ⑥ 이용자는 변경된 약관에 동의하지 않을 경우 회원 탈퇴(해지)를 요청할 수 있으며, 변경된 약관의 효력 발생일로부터 7일 이후에도 거부의사를 표시하지 아니하고 서비스를 계속 사용할 경우 약관의 변경 사항에 동의한 것으로 간주됩니다.                      </li>
                    </ul>
                  </li>
                  <li>
                    제3조 (용어의 정의)
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        ③ 국립암센터(국가암데이터센터) K-CORE는 다음 각 호에 해당하는 회원가입에 대하여는 가입을 취소할 수 있습니다.
                      </li>
                      <li>
                      ...
                      <li>
                        6. 입력한 비밀번호가 <span style={{ "color": "red" }}> 9자 이상 20자 이내(영대문자, 영소문자, 숫자, 특수문자 3종류 혼용)가 아닌 경우</span>
                      </li>
                      <li>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        ② 이용자가 다음 각 호의 사유에 해당하는 경우, 국립암센터(국가암데이터센터) K-CORE는 회원자격을 상실시킬 수 있습니다.
                      </li>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        ② 국립암센터(국가암데이터센터) K-CORE는 제1항의 사유로 서비스 제공이 일시적으로 중단의 경우에는 국립암센터(국가암데이터센터) K-CORE 홈페이지에 사전 게시함으로써 이용자 개별통지를 대신할 수 있습니다. 다만, 국립암센터(국가암데이터센터) K-CORE가 통제할 수 없는 사유로 인한 서비스의 중단(시스템 관리자의 고의, 과실이 없는 디스크 장애, 시스템 다운 등)으로 인하여 사전 통지가 불가능한 경우에는 그러하지 아니합니다.
                      </li>
                      <li>
            ...
            <ul className="scrollList">
              <li>
                <font>
                  ...
                  1. 개인정보의 수집·이용 목적                </font>
                <ul>
                  <li>

                    홈페이지 회원가입 및 관리 , 고지사항 전달, 불만처리 등을 위한 원활한 의사소통 경로의 확보
                  </li>
                </ul>
              </li>
              <li>
              ...
              <li>
                ...
                <ul>
                  ...
                  <font>
                    4. 귀하는 이에 대한 동의를 거부할 수 있습니다.
                  </font>
                  <ul>
                    <li>다만, 동의가 없을 경우 홈페이지 서비스 이용, 고지사항 전달 등 관련 서비스가 원활하게 진행되지 않을 수 있습니다.</li>
                  </ul>
