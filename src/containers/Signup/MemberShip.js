...
const MemberShip = ({ changestep }) => {
  ...
  const isEmailExist = useSelector((data) => data.homeReducer.is_email_exist);
  const registration_status = useSelector((data) => data.homeReducer.registration_status);

  const mobile_verified = useSelector((data) => data.homeReducer.mobileVerified);
  ...
  const formSet = (e) => {
    ...
    if (name === 'id' && value === '') {
      ...
      errors.id =
        'ID should be combination of capital/lowercase alphabets and numbers in 6-10 letters. Koreans and special symbols are not allowed';
    ...
    if (name === 'password' && value === '') {
      ...
      errors.password =
        'The password should be more than 9 and lessthan 20 characters(contain at least three character categories among the following: uppercase, lowercase, numeric, or special character)';
    ...
    } else if (name === 'phone_number' && value.length > 20) {
  ...
  useEffect(() => {
    let instituteOptionsKorean = ['정부기관', '대학기관', '연구센터', '병원', '산업', '그 외'];
          ...
          <div className="grid grid-cols-4">
            ...
            <div className="col-span-3 p-8 bg-white border-b-2 border-gray-300  gap-3">
              ...
              <div className="flex flex-col">
                <p></p>
                {checkUserId && (
                  <span className="text-red-500 text-md">User Id Already exists</span>
                )}
                {!form.errors.id && (
                ...
                {form.errors.id && (
                  <span className="text-red-500 text-sm">
                    <FormattedMessage id={form.errors.koreanid} defaultMessage={form.errors.id} />
                  </span>
                )}
              </div>
            </div>
            ...
            <div className="col-span-3 p-8 bg-white border-b-2 border-gray-300">
              <div className="mb-3 pt-0 relative">
                ...
                />
                <span className="absolute cursor-pointer left-80 top-2">
                  {' '}
                  {visibility ? (
                    <EyeIcon
                      className="h-14 w-12 inline text-main-white"
            ...
            <div className="col-span-1 bg-gray-200 bg-gray-200 p-8 border-b-2 border-gray-300">
              <span className="font-bold">
                {koreanlanguage ? '비밀번호 확인' : 'Verify Password'}
              </span>
              <span className="text-red-500">*</span>
            </div>
            <div className="col-span-3 p-8 bg-white border-b-2 border-gray-300">
            ...
            <div className="col-span-3 p-8 bg-white border-b-2 border-gray-300">
              ...
              {form.errors.name && (
                <span className="text-red-500 text-sm">
                  <FormattedMessage id={form.errors.koreanname} defaultMessage={form.errors.name} />
                </span>
              )}
            </div>
                  ...
                  {emailExist && (
                    <span
                      className={`text-red-500 text-sm ${
                        emailExist === 'Email is Already Registerd' ? '' : 'hidden'
                      }`}
                    >
            ...
            <div className="col-span-3 p-8 bg-white border-b-2 inline-flex flex-column  border-gray-300">
              <div className="">
                <div className="">
                  ...
                  />
                  &nbsp;
                  <label htmlFor="mobile_verification">
                    {koreanlanguage ? '휴대폰' : 'Mobile'}
                  </label>
                  <input
                    type="radio"
              ...
              <div>
                ...
                {verificationState === 'mobile' && ClickMobileverifyButton && (
                  <button
                    ...
                    className="bg-main-blue mt-2 hover:bg-main-blue mb-3 lg:w-80 sm:w-40 lg:h-16 sm:h-16 xs:text-sm sm:text-xl lg:text-2xl text-white ml-2 font-bold py-2 px-4 border border-blue-700 rounded"
                  >
                    {koreanlanguage ? '확인 확인' : 'Verify Mobile'}
                  </button>
                )}
              </div>
              <div>
              ...
              {emailExist === 'Email is Not Registered' &&
        ...
        <div className="inline-flex gap-2  my-6">
          ...
          <button
            className={`text-white font-bold py-6 px-6  float-right rounded ${
              RegistrationClass === true ? 'bg-NccBlue-700 hover:bg-blue-700' : 'bg-grey-700 '
            }`}
