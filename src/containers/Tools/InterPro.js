                  ...
                  <div>
                    ...
                    <div className="Flex FlexDirCol ItemsCenter" style={{ gap: "10px" }}>
                      <div>
                        <dl>
                          <dt>
                            <FormattedMessage id="SequenceInFormat" defaultMessage="Sequence, in FASTA format" />
                          </dt>
                          <dd>
                            <div className="">
                              <FormattedMessage id="EnterYourSequence" defaultMessage="Enter your sequence" >
                                {(msg) =>
                                  <textarea type="file" className="w100"
                                    id="message"
                                    rows="4"
                                    placeholder={msg} autoComplete="off" style={{ padding: "10px" }} />
                                }
                              </FormattedMessage>
                    ...
                    <span style={{ fontSize: "1rem", lineHeight: "1.5rem", justifyContent: "center", marginTop: "40px" }} className='Flex'>
                      <FormattedMessage id="interProNote" defaultMessage="Note: protein sequence in .fasta format" />
