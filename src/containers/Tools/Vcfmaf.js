...
function Vcfmaf() {
  ...
  const handleFileChange = (e) => {
    ...
    // Check if the total number of files does not exceed 50 and the total size is less than or equal to 2GB
    if (totalSize + newFilesSize <= 2000 * 1024 * 1024) {
      // if (totalSize + newFilesSize <= 5 * 1024) {
      ...
      // else if (totalSize + newFilesSize > 5 * 1024) {
