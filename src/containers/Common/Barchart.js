  ...
  useEffect(() => {
    if (data) {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        if (
          id !== 'chart_bar_TCategory' &&
          id !== 'chart_bar_NCategory' &&
          id !== 'chart_bar_DurationofBreastfeeding' &&
          id !== 'chart_bar_Ki-67Index' &&
          id !== 'chart_bar_HER2Score' &&
          id !== 'chart_bar_Timeuntilrelapseisconfirmed' &&
          id !== 'chart_bar_FirstMenstrualAge' &&
          id !== 'chart_bar_AgeOfDaignosis' &&
          id !== 'chart_bar_BodyMassIndex'
        ) {
          linear = linear - 0.2;
        }
      }
