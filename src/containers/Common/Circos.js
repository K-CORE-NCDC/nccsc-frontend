...
export default function CircosCmp({ width, data }) {
  ...
  const drawCircos =  (width, GRCh37, cytobands,api_data) => {
    ...
    var rna_expression_up = api_data['rna_expression'].reduce(function (tmp,d) {
    ...
    var rna_expression_down = api_data['rna_expression'].reduce(function (tmp,d) {
      if(d.rna_cnt < -1){
        let dt = {
          block_id: d.chromosome,
          position: (parseInt(d.start_position) + parseInt(d.end_position)) / 2,
    ...
    var dna_methylation = api_data['dna_methylation'].map(function (d,i) {
      return {
        block_id: d.chromosome,
        position: (parseInt(d.start_position) + parseInt(d.end_position)) / 2,
    ...
    var global_proteome_up = api_data['global_proteome'].reduce(function (tmp,d) {
      if(d.rna_cnt>1){
        tmp.push({
          block_id: d.chromosome,
          position: (parseInt(d.start_position) + parseInt(d.end_position)) / 2,
    ...
    var global_proteome_down = api_data['global_proteome'].reduce(function (tmp,d) {
      if(d.rna_cnt<-1){
        tmp.push({
          block_id: d.chromosome,
          position: (parseInt(d.start_position) + parseInt(d.end_position)) / 2,
