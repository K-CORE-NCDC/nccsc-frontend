    ...
    <div>
      ...
      <div className="flex flex-row mb-4 ml-4">
        ...
        <div className="flex items-center ml-4">
          <input id="default-radio-1" type="radio" value="and" name="condition" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
          <label htmlFor="default-radio-1" className="ml-2 text-gray-900 dark:text-gray-300">And</label>
        </div>
        <div className="flex items-center ml-4">
          <input id="default-radio-2" type="radio" value="or" name="condition" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
          <label htmlFor="default-radio-2" className="ml-2 text-gray-900 dark:text-gray-300">Or</label>
        </div>
      </div>
