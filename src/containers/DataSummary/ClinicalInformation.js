// import { AdjustmentsIcon, BeakerIcon, DocumentAddIcon, SearchIcon, UserCircleIcon } from '@heroicons/react/outline';
...
//       'Duration of Breastfeeding (Targeting Experience of Breastfeeding Y respondents(58))',
//     'Time until relapse is confirmed':
//       'Time until relapse is confirmed (Targeting Cancer Recurrence Y respondents(44))'
//   };
...
//                   {itm in chart_names ? (
//                     <FormattedMessage id={itm} defaultMessage={chart_names[itm]} />
//                   ) : (
...
//                   className="relative"
//                   id={'div_' + id}
//                   onClick={(e) => checkBoxFn(e, 'md_' + i, itm)}
//                 >
//                   <input
//                     type="checkbox"
//                     id={'md_' + i}
...
//               {icon_type[item]}
//               <span className="no-underline  ml-5 text-2xl tracking-wide">
//                 <FormattedMessage id={item} defaultMessage={item} />
//               </span>
//             </label>
//             {selected === item ? (
//               <div className="tab-content overflow-hidden border-l-2 bg-gray-100  leading-normal relative">
//                 {t}
//               </div>
//             ) : (
//               ''
...
//                 key={'chart_' + item}
//                 data-chart="bar"
//                 className="max-w bg-white rounded-2xl overflow-hidden shadow-lg px-4 py-3 mb-5 mx-3 card-border"
//               >
//                 <h2 className="lg:text-3xl md:text-2xl sm:text-2xl tracking-wide">
//                   {item in chart_inside_names ? (
//                     <FormattedMessage
//                       id={item + '_chart'}
//                       defaultMessage={chart_inside_names[item]}
//                     />
//                   ) : (
//                     <FormattedMessage id={item} defaultMessage={item} />
//                   )}
...
//               <div
//                 className={`sm:hidden xs:opacity-95 sm:opacity-95 lg:block xl:block bg-white border border-gray-200 ${smallScreen ? '' : 'xs:hidden'
//                   }`}
//               >
//                 <h4 className="p-3 float-left">
//                   <AdjustmentsIcon className="h-6 w-6 inline" /> &nbsp;Filters
//                 </h4>
//                 <button
...
//             </div>
//             <div
//               className={`xl:col-start-2 lg:col-start-2 col-span-4 m-5 overflow-y-auto h-screen ${smallScreen ? 'absolute' : ''
//                 }`}
//               id="charts_container"
//             >
