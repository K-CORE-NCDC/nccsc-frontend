        ...
        <div className="popularBox">
          ...
          <div className="contentBox">
            <ul className="contentBox_left" style={{width:'100%'}}>
              ...
              <li tabIndex="-1" >
                <p> <b>Interpro  :</b> &nbsp;
                  <FormattedMessage id="Example_tools_interPro" defaultMessage='represent genomic/proteomic data in the form of a map or diagram in which data values are represented as colors(heats)' />
                </p>
              </li>
              <li className="" tabIndex="-1" >
                <p><b>BLAST :</b>  &nbsp;
                  <FormattedMessage id="Example_tools_blast" defaultMessage=' compare primary biological sequence information by using protein amino acid sequence or DNA/RNA sequence information (DNA, RNA, Protein sequence or FASTA file needed)' />
                </p>
              </li>
            </ul>
