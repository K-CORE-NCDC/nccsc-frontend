    ...
    return(
        <section className="intro_wrap">
          ...
          <ul className="intro_tab tab_title_main">
              ...
              <li className={tabs === 2?"on":"" }>
              <a onClick={()=>setTabs(2)}>
                <FormattedMessage  id = {"Cancer Proteogenomics Working Group"} defaultMessage={"Cancer Proteogenomics"}/>
              </a></li>
          ...
          <ul className="at">
            ...
            <li className={tabs === 2?"at2 on":"at2"}>
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div className="txtbox">
                      <h3><b><FormattedMessage  id = {"Cncr_1"} defaultMessage={"To administrate “Cancer Proteogenomics"}/></b></h3>
                      <p><FormattedMessage  id = {"Cncr_2"} defaultMessage={"which is a research group formed  at the National Cancer Center"}/><br/>
                              <FormattedMessage  id = {"Cncr_3"} defaultMessage={"o discover new biomarkers for cancer through cancer proteogenomics analysis"}/><br/>
