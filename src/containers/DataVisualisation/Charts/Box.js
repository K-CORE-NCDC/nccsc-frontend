              ...
              <ul>
                ...
                {project_id === undefined && (
                  <li className={activeTab === '2' ? 'on' : ''}>
                    ...
                    >
                      {' '}
                      <FormattedMessage id="RNA" defaultMessage="RNA" />{' '}
                    </button>
                  </li>
                )}
                ...
                <ul>
                  <li className={selectedType === '1' ? 'on' : ''}>
                    ...
                    <button
                      ...
                      name="view"
                      className={viewType === 'gene_vl' ? selected_button : normal_button}
                    >
                      Raw count
                    </button>
                  </li>
                  <li className={selectedType === '2' ? 'on' : ''}>
                    <button
                      ...
                      name="view"
                      className={viewType === 'z_score' ? selected_button : normal_button}
                    >
                      Normalization
                    </button>
                  </li>
            ...
            {tableType && (
              <p className="text_align" style={{ marginBottom: '30px' }}>
                {tableType === 'proteome' ? (
                  <FormattedMessage
                    id="BoxTvNDesc"
                    defaultMessage="Proteome expression of Tumor samples vs Normal samples"
                  />
                ) : (
                  <FormattedMessage
                    id="BoxRnaDesc"
                    defaultMessage="RNA expression of Tumor samples vs Normal samples"
                  />
                )}
              </p>
            )}
