        ...
        <div className="mx-5 sm:col-span-2 xs:col-span-2 lg:col-span-1">
          <div className="flex m-2 w-100">
            <button
              ...
              name="type"
              className="rounded-r-none  hover:scale-110 focus:outline-none flex lg:p-5 sm:p-2 lg:px-10 md:px-10 sm:px-8 sm:w-40 md:w-48  lg:w-48 sm:text-xl lg:text-2xl sm:h-16 lg:h-20 rounded
            ...
            <button
              ...
              name="type"
              className="rounded-l-none  hover:scale-110 focus:outline-none flex justify-center lg:p-5 sm:p-2 sm:w-40 md:w-48 lg:w-48 sm:text-xl lg:text-2xl sm:h-16 lg:h-20 rounded font-bold cursor-pointer hover:bg-teal-200
