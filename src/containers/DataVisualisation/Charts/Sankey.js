...
function Sankey({gene,width,exampleNodes,exampleLinks}) {
  // console.log(gene)

  const drawChart = (gene,exampleNodes,exampleLinks)=>{
    ...
    var OPACITY = {
      ...
      TYPES = ["Gene", "Variant", "Rsid", "Disease", "Drug"],
      ...
      tooltip = d3.select("#chart_"+gene).append("div").attr("id", "tooltip");
  ...
  useEffect(()=>{
    if(gene){
      ...
      drawChart(gene,exampleNodes,exampleLinks)
    }
  },[])  
  return (
