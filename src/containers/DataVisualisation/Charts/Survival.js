      ...
      loader ?
        ...
        <div className="flex flex-row justify-around">
          <div className="w-1/5 border bg-white">
            ...
            {(filterTypeButton === 'clinical') && <h6 className="p-4 ml-1 text-left text-bold text-blue-700">
              <FormattedMessage id="Choose Filter group" defaultMessage='Choose Filter group' />
            </h6>}
            {(filterTypeButton === 'clinical') && <div className="m-1 flex flex-row justify-around">
