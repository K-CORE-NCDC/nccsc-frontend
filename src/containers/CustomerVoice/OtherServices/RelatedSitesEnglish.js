      ...
      <div className="grid grid-col-4">
        <div className="col-span-4">
          <section className="intro_wrap_organoid mx-auto">
            <h1 className="m-5 text-4xl font-bold my-5" style={{ marginLeft: '-8px' }}>
              Related Sites
            </h1>
          </section>
        </div>
      ...
      <table className=" table border border-black text-center mx-auto">
        <tbody>
          <tr className="border border-black text-center py-10">
            <th className="border border-black text-center p-12" style={{ width: '5rem' }}>
              No.
            </th>
            <th className="border border-black text-center" style={{ width: '70rem' }}>
              Related Sites
            </th>
            <th className="border border-black text-center" style={{ width: '40rem' }}>
              Link
            </th>
          </tr>
          ...
          <tr className="border border-black text-center">
            ...
            <td className="border border-black text-center">
              GDC Data Portal of National Cancer Institute (US)
            </td>
