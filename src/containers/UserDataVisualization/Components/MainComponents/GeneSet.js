        ...
        <label htmlFor="gene_type" className="ItemsCenter"></label>
          <FormattedMessage id="EnterYourGenes" defaultMessage="Enter Your Genes">
            ...
            <select
              ...
              className="selectBox"
            >
              <option className="GeneSetGeneOption" value="user-defined" placeholder={placeholder}>
                <FormattedMessage id="UserDefinedList" defaultMessage="User-Defined List" />
              </option>
              {pca && <option value="all-genes"> All Genes </option> }
              ...
              <option value="other-grow-prol-signal">
                General: Other growth/proliferation signaling (11 genes)
              </option>
              <option value="survival-cell-signal">
                General: Survival/cell death regulation signaling (23genes)
              </option>
              ...
              <option value="pi3k-akt-mtor-signal">
                General: PI3K-AKT-mTOR signaling (17 genes)
              </option>
              <option value="ras-raf-signal">
                General: Ras-Raf-MEK-Erk/JNK signaling (26 genes)
              </option>
              <option value="regu-ribo-cell">
                General: Regulation of ribosomal protein synthesis and cell growth (9 genes)
              </option>
