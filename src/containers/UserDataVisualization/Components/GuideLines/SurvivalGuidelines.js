...
const SurvivalGuidelines = (plot_type) => {
  return (
        ...
        <div className=" flex justify-between py-4 px-4">
          <div className="py-6">
            <ol className="list-decimal px-10 py-2">
              ...
              <li className="py-2">
                <span className="text-red-400">rlps_yn : </span> &nbsp; should tell whether an event
                has occurred or not
                <p className="px-3 py-4"> ● For an event, please use one of the following: </p>
              ...
              <li className="py-2">
                <span className="text-red-400">rlps_cnfr_drtn</span> &nbsp; should tell how long it
                took for an event to be confirmed. (e.g. 40.12).
              </li>
            </ol>
          </div>
        </div>
...
export default SurvivalGuidelines;
