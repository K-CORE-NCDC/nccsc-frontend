...
<h2 className="py-2 text-3xl text-green-300">임상정보 형식
</h2>
...
<h1 className="py-2 text-green-300 text-4xl"> Proteome 정보 형식 (선택)
</h1>
...
<h1 className="py-2 text-green-300 text-4xl"> Copy Number Variation 정보 형식 (선택)
</h1>
<h2 className="text-3l my-4">모든 행은 탭(tab)으로 분리된 형식입니다.
</h2>
<div className="py-2">
<p>첫번째 (머리) 행은 ‘sample_id’ 와 각 유전정보의 이름으로 이루어집니다. </p>
