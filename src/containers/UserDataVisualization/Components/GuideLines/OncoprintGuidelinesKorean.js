...
const OncoprintGuidelinesKorean = () => {
  return (
    <div className="px-10 py-10 overflow-auto" style={{ height: '60vh' }}>
      ...
      <h2 className="py-8">
        첫번째 (머리) 행은 ‘sample_id’ 와 각 임상변수의 이름으로 이루어집니다. 첫 번째 행의 예시 :
      </h2>
      ...
      <p className="py-4">
        다음 행은 샘플 아이디(sample id), 각 임상변수의 값으로 이루어집니다. 값이 없을 경우, 빈
        칸으로 남겨둡니다.
      </p>
      ...
      <p className="py-3">
        사용자는 임상정보를 업로드 한 후, 각 컬럼의 자료형(data type)을 결정해야 합니다. 선택가능한
        임상정보 자료형은 문자형(character), 숫자형(number), 실수형(decimal), 논리형(yes/no)입니다.
        만약 입력한 값이 선택된 자료형과 맞지 않는다면, 해당 데이터는 QC 단계에서 빨간색으로 강조
        표시됩니다.
      </p>
      ...
      <div className="py-8">
        ...
        <ol className="list-decimal px-10 py-2 pt-8">
          ...
          <li className="py-1">
            <span className="text-red-400">gene_name: </span> &nbsp; 은 공식 유전자 심볼(HUGO)
            형식으로 주어져야 합니다.
          </li>
          <li className="py-1">
          ...
          <li className="py-1">
            <span className="text-red-400">start_position :</span> &nbsp; 변이의 시작 위치 (예.
            1573418)
          </li>
          <li className="py-1">
            <span className="text-red-400">end_position : </span> &nbsp; 변이의 끝 위치 (예.
            1573418)
          </li>
          <li className="py-1">
            <span className="text-red-400">variant_classification : </span> &nbsp; 변이는 초래하는
            결과에 따라 아래와 같이 분류됩니다.
            <p className=" py-2"> ● 7가지 변이 분류 </p>
          ...
          <li className="py-1">
            <span className="text-red-400 px-20">variant_type :</span> 변이는 유형에 따라 아래와
            같이 분류됩니다.
            <p className="px-3 py-2"> 3가지 변이 타입 </p>
          ...
          <li className="py-1">
            <span className="text-red-400 pl-20">protein_change : </span> &nbsp; 아미노산 변화 (예.
            p.R586R)
          </li>
          <li className="py-1">
            <span className="text-red-400 pl-20">swiss_prot_acc_id : </span> &nbsp; SwissProt 단백질
            ID (예. O60477)
          </li>
          <li className="py-1">
            <span className="text-red-400 pl-20">annotation_transcript : </span> &nbsp; Ensembl
            유전자 ID (예. ENST00000449103.1)
          </li>
          <li className="py-1">
            <span className="text-red-400 pl-20">refseq_mrna_id : </span> &nbsp; RefSeq mRNA ID (예.
            NM_001128432.2)
          </li>
        </ol>
      </div>
      ...
      <div className="pt-2 my-4">
        ...
        <ol className="list-decimal px-10 py-2">
          ...
          <li className="py-1">
            <span className="text-red-400">z_score :</span> &nbsp; RNA 발현 값의 표준 점수 (예.
            -0.29075)
          </li>
        </ol>
      </div>
      ...
      <div className="py-6">
        ...
        <ol className="list-decimal px-10 py-2">
          ...
          <li className="py-1">
            ...
            <p className="px-3 py-2"> 한 샘플에 대하여, 아래 중 하나의 타입으로 지정해주세요. </p>
            <ul className="list-disc px-20">
          ...
          <li className="py-1">
            <span className="text-red-400">z_score : </span> &nbsp; Proteome 발현값의 표준 점수 (예.
            0.599818)
          </li>
        </ol>
      </div>

      <h1 className="py-2 text-green-300 text-4xl"> Copy Number Variation 정보 형식 (선택)</h1>
      ...
      <div className="py-2">
        ...
        <ol className="list-decimal px-10 py-2">
          ...
          <li className="py-1">
            <span className="text-red-400">gene </span> &nbsp; 은 공식 유전자 심볼(HUGO) 형식으로
            주어져야 합니다.
          </li>
          <li className="py-1">
            <span className="text-red-400">chromosome : </span> &nbsp; 염색체 번호 (예. chr3)
          ...
          <li className="py-1">
            <span className="text-red-400">cn : </span> &nbsp; 복제수(copy numbers)는 0 이상의
            정수를 입력합니다.
          </li>
          <li className="py-1">
            <span className="text-red-400">depth : </span> &nbsp; 실수(decimal) 형태의 값을
            입력합니다.
          </li>
          <li className="py-1">
          ...
          <li className="py-1">
            <span className="text-red-400">weight: </span> &nbsp; 실수(decimal) 형태의 값을
            입력합니다.
          </li>
        </ol>
      </div>

      <h1 className="py-2 text-green-300 text-4xl"> Fusion gene 정보 형식 (선택)</h1>
      <h2 className="text-3xl my-4">모든 행은 탭(tab)으로 분리된 형식입니다.</h2>
      <div className="py-2">
        <p>첫번째 (머리) 행은 ‘sample_id’ 와 각 유전정보의 이름으로 이루어집니다.</p>
        <ol className="list-decimal px-10 py-2">
          ...
          <li className="py-1">
            <span className="text-red-400">left_gene_name </span> &nbsp; 은 공식 유전자 심볼(HUGO)
            형식으로 주어져야 합니다.
          </li>
          <li className="py-1">
            <span className="text-red-400">left_gene_chr : </span> &nbsp; 왼쪽 유전자의 염색체
            이름(예.chr8)
          </li>
          <li className="py-1">
            <span className="text-red-400">left_hg38_pos : </span> &nbsp; 왼쪽 유전자의 위치 - hg38
            기준(예. 140793354)
          </li>
          <li className="py-1">
            <span className="text-red-400">right_gene_name : </span> &nbsp; 은 공식 유전자
            심볼(HUGO) 형식으로 주어져야 합니다.
          </li>
          <li className="py-1">
            <span className="text-red-400">right_gene_chr : </span> &nbsp; 오른쪽 유전자의 염색체
            이름 (예.chr8)
          </li>
          <li className="py-1">
            <span className="text-red-400">right_hg38_pos : </span> &nbsp; 오른쪽 유전자의 위치 -
            hg38 기준 (예. 140793354)
          </li>
        </ol>
      </div>
...
export default OncoprintGuidelinesKorean;
