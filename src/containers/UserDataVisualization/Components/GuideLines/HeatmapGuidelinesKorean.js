...
<li className='py-1'>
<span className="text-red-400">gene_vl : </span> &nbsp; Proteome expression values (예. 1.13929)
</li>
<li className='py-1'>
<span className="text-red-400">z_score : </span> &nbsp; Proteome expression values in Z-score (예. 0.599818)
</li>
</ol>
</div>
<h1 className="pt-10 pb-2 text-4xl py-2 text-3xl text-green-300"> Phospho-proteome 정보 형식</h1>
<h2 className="text-3xl my-4">모든 행은 탭(tab)으로 분리된 형식입니다.</h2>
<h2 className="py-4"> 첫번째 (머리) 행은 ‘sample_id’ 와 각 유전정보의 이름으로 이루어집니다.</h2>
<ul className="py-4">
<li className='py-1'>
<span className="text-red-400 pl-20">sample_id : </span> &nbsp;
는 임상정보와 일치해야 합니다.
</li>
<li className='py-1'>
<span className="text-red-400 pl-20">type : </span> &nbsp;
샘플의 타입.
...
<li className='py-1'>
<span className="text-red-400 pl-20">site : </span> &nbsp;
phosphorylation 위치 (예. S24)
</li>
<li className='py-1'>
<span className="text-red-400 pl-20">gene_vl : </span> &nbsp;
phospho-proteome 값 (예. 0.890428)
</li>
<li className='py-1'>
<span className="text-red-400 pl-20">z_score : </span> &nbsp;
phospho-proteome 값의 표준 점수 (예. -1.41693)
</li>
