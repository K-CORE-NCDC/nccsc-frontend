...
const HeatMapGuidelines = (plot_type) => {
  return (
    <div className="px-10 py-10 overflow-auto" style={{height:'60vh'}}>
      ...
      <h1 className="pt-10 pb-2 text-4xl py-2 text-3xl text-green-300">phospho-proteome data format :</h1>
      <h2 className="py-4"> The first (header) row gives the name of each genomic information, as well as 'sample_id'.</h2>
      <ul className="py-4">
      <li className='py-1'>
        <span className="text-red-400 pl-20">sample_id : </span> &nbsp;
        should match clinical information
    </li>
    <li className='py-1'>
            <span className="text-red-400 pl-20">type : </span> &nbsp;
            type of samples. it has to be one of the following

            <div className="px-24 py-2">
              {" "}
              <p>● For a sample, please use either one of sample types below:</p>{" "}
        ...
        phosphorylation site (e.g. S24)
    </li>
    <li className='py-1'>
        <span className="text-red-400 pl-20">gene_vl : </span> &nbsp;
        phospho-proteome values (e.g. 0890428)
    </li>
    <li className='py-1'>
        <span className="text-red-400 pl-20">z_score : </span> &nbsp;
        phospho-proteome values in Z-score (e.g. -1.41693)
    </li>
...
export default HeatMapGuidelines;