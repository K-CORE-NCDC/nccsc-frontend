          ...
          <div className="tab_main">
            <ul>
              <li className={activeTab === '1' ? 'on' : ''}>
                ...
                >
                  <FormattedMessage id="CustomerService_tab1" defaultMessage="Notice" />
                </button>
              </li>
              <li className={activeTab === '2' ? 'on' : ''}>
                ...
                >
                  <FormattedMessage id="CustomerService_tab2" defaultMessage="Archive" />
                </button>
              </li>
              <li className={activeTab === '3' ? 'on' : ''}>
                ...
                >
                  <FormattedMessage id="CustomerService_tab3" defaultMessage="FAQ" />
                </button>
              </li>
              <li className={activeTab === '4' ? 'on' : ''}>
                ...
                >
                  <FormattedMessage id="CustomerService_tab4" defaultMessage="Others" />
                </button>
              </li>
            </ul>
          </div>
