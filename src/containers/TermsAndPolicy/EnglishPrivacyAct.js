                ...
                <div id="DIV_2" className=''>
                  <div id="DIV_52">
                    ...
                    <div className='div_64'>
                      <div className='div_64_1'>[Primary personal information processing indication (labeling)]</div>
                      <div className='div_64_box'>
                        <div className='div_64_box_div'>
                          <img src={RightsandObligationsofDataSubjects}
                            alt="RightsandObligationsofDataSubjects" id="IMG_82" className='div_64_box_img' />
                          <span className='div_64_box_text'>Information subject's rights and obligations</span>
                        </div>
                        <div className='div_64_box_div' >
                          <img src={requestforreading}
                            alt="requestforreading" id="IMG_82" className='div_64_box_img' />
                          <span className='div_64_box_text'>Request for reading
                          </span>
                        </div>
                        <div className='div_64_box_div'>
                          <img src={RemediesforInfringementofRights}
                            alt="RemediesforInfringementofRights" id="IMG_82" className='div_64_box_img' />
                          <span className='div_64_box_text'>Remedies for Infringement of Rights</span>
                        </div>
                        <div className='div_64_box_div'>
                          <img src={Purposeofpersonalinformationprocessing}
                            alt="Purposeofpersonalinformationprocessing" id="IMG_82" className='div_64_box_img' />
                          <span className='div_64_box_text'>Purpose of Personal information processing</span>
                        </div>
                        <div className='div_64_box_div'>
                          <img src={Provisionofpersonalinformation}
                            alt="Provisionofpersonalinformation 제공" id="IMG_82" className='div_64_box_img' />
                          <span className='div_64_box_text'>Provision of Personal information</span>
                        </div>
                        <div className='div_64_box_div'>
                          <img src={Processingitems}
                            alt="Processingitems" id="IMG_82" className='div_64_box_img' />
                          <span className='div_64_box_text'>Processing Items</span>
                        </div>
                        <div className='div_64_box_div'>
                          <img src={processingconsignment}
                            alt="processingconsignment " id="IMG_82" className='div_64_box_img' />
                          <span className='div_64_box_text'>Processing Consignment</span>
                        </div>
                        <div className='div_64_box_div'>
                          <img src={PersonalInformatonProtectionOfficer}
                            alt="PersonalInformatonProtectionOfficer" id="IMG_82" className='div_64_box_img' />
                          <span className='div_64_box_text'>Personal informaton Protection Officer</span>
                        </div>
                        <div className='div_64_box_div'>
                          <img src={Personalinformationprocessing}
                            alt="Personalinformationprocessing" id="IMG_82" className='div_64_box_img' />
                          <span className='div_64_box_text'>Personal information Processing</span>
                        </div>
                        <div className='div_64_box_div'>
                          <img src={Measurestoensuresafety}
                            alt="Measurestoensuresafety" id="IMG_82" className='div_64_box_img' />
                          <span className='div_64_box_text'>Measures to ensure Safety</span>
                        </div>
                        <div className='div_64_box_div'>
                          <img src={GrievanceHandlingDepartment}
                            alt="GrievanceHandlingDepartment" id="IMG_82" className='div_64_box_img' />
                          <span className='div_64_box_text'>Grievance Handling Department</span>
                        </div>
                        <div className='div_64_box_div'>
                          <img src={Generalpersonaliformationcollection}
                            alt="Generalpersonaliformationcollection" id="IMG_82" className='div_64_box_img' />
                          <span className='div_64_box_text'>General Personal information Collection</span>
                        </div>
                      </div>
                      {/* <div></div> */}
                    </div>
                    ...
                    <div className='div_64 MarginTop10' style={{ padding: '2%' }}>
                      ...
                      <p className='MarginTop10'>②	The personal information-related laws handled by National Cancer Center (National Cancer Data Center) K-CORE are governed by Article 9-2 of the Cancer Control Act (cancer data business) and Article 15, Paragraph 1, Item 2 of the Personal Information Protection Act (collection and use of personal information), and Article 28-2 (Processing of pseudonymous information, etc.) of the 「Personal Information Protection Act」. They are processed in compliance with the personal information protection regulations.</p>
                      <p className='MarginTop10'>③	The personal information operated by the National Cancer Center (National Cancer Data Center) K-CORE does not include information that can be used to identify a specific individual, and if that information is generated, it will be withdrawn and get destroyed without delay </p>
                    </div>
                    ...
                    <div className='div_64' style={{ padding: '2%' }}>
                      <p className='MarginTop10'>① In the course of using the service at the National Cancer Center (National Cancer Data Center) K-CORE, service use records such as IP address, cookies, and visit date/time/bad use records may be created and collected. </p>
                      <p className='MarginTop10'> ② In the process of using the service, information about the user is created and stored (collected) in an automated way, or the unique information of the user's device is safely converted so that the original value cannot be checked and then collected. </p>
                      <p className='MarginTop10'>③ To install, operate, and reject cookies, you can refuse to save cookies by setting options in the Tools {'>'} Internet Options {'>'} Personal Information menu at the top of the web browser. </p>
                      <p className='MarginTop10'> ④	If you refuse to store cookies, you may experience difficulties in using the web service.</p>
                    </div>
                    ...
                    <div className='div_64' style={{ padding: '2%' }}>
                      <p className='MarginTop10'>
                        ① National Cancer Center (National Cancer Data Center) K-CORE destroys personal information without delay when the purpose of processing personal information is achieved </p>
                      <p className='MarginTop10'>② The destruction procedure, deadline, and method are as follows.</p>
                    ...
                    <div className='div_64 ' style={{ padding: '2%' }}>
                      ...
                      <p className='MarginTop10'> ② National Cancer Center (National Cancer Data Center) K-CORE handles the restrictions on the processing of personal information pursuant to paragraph ① in accordance with the following documents.</p>
                      <ul className=''>
                        <li className='MarginTop10'>
                      ...
                      <p className='MarginTop10'>③ If the contents of the consignment work or the consignee are changed, we will disclose it through this personal information processing policy without delay.</p>
                    </div>
                    ...
                    <div className='div_64' style={{ padding: '2%' }}>
                      <p className='MarginTop10'>① National Cancer Center (National Cancer Data Center) K-CORE is taking technical, administrative, and physical measures to ensure the safety of personal information in accordance with Article 29 (Obligation of Safety Measures) of the 「Personal Information Protection Act」.</p>
                      <ul >
                        <li className='MarginTop10'>
                    ...
                    <div className='div_64' style={{ padding: '2%' }}>
                      <p > ① The information subject may make a request for access to personal information pursuant to Article 35 of the Personal Information Protection Act to the following departments. We will promptly process the personal information access request of the information subject.</p>
                      <ul className='MarginTop10'>
                        <li className='MarginTop10'>
                        ...
                        <li >
                          <a href={Attachments} download style={{ color: 'cornflowerblue' }}>☞ Personal_information_access_correction_deletion_request_form download [Attachment 1]</a>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className='div_64' style={{ padding: '2%' }}>
                      <p className='MarginTop10'>① The information subject may apply for dispute resolution or consultation to the Personal Information Dispute Mediation Committee, the Korea Internet & Security Agency Personal Information Infringement Report Center, etc.</p>
                      <ul className='MarginTop10'>
                    ...
                    <div className='div_64 MarginTop10' style={{ padding: '2%' }}>
                      ...
                      <p className='MarginTop10'>②	National Cancer Center (National Cancer Data Center) Send all personal information protection related inquiries, complaint handling, damage relief, etc. that occurred while using K-CORE to the person in charge of personal information protection, personal information protection officer, and working person at the National Cancer Data Center You can contact us. We will respond and handle inquiries from the information subject without delay.</p>
                    </div>
