            ...
            <div id="DIV_2" className='m-14'>
                <div id="DIV_52">
                    ...
                    <div id="DIV_134" className='m-5'>
                        ...
                        </table><br id="BR_155" /> ② 국립암센터(국가암데이터센터) K-CORE에서 처리하고 있는 개인정보 관련 법률은 「암관리법 제9조의2(암데이터사업)」 및 「개인정보 보호법」 제15조(개인정보의 수집ㆍ이용) 제1항 제2호,「개인정보 보호법」 제28조의2(가명정보의 처리 등)에 따라서 개인정보 보호 규정을 준수하여 처리하고 있습니다.<br id="BR_156" />
                    ...
                    <div id="DIV_160">
                        ① 국립암센터(국가암데이터센터) K-CORE에서 서비스 이용 과정 시 IP주소, 쿠키, 방문 일시·불량 이용 기록 등의 서비스 이용 기록이 생성되어 수집될 수 있습니다. <br
                            id="BR_161" /> 
                           ② 서비스 이용 과정에서 이용자에 관한 정보를 자동화된 방법으로 생성하여 이를 저장(수집)하거나, 이용자 기기의 고유한 정보를 원래의 값을 확인하지 못하도록 안전하게 변환한 후에 수집합니다. <br id="BR_162" />
                        ③ 쿠키의 설치·운영 및 거부 방법은 웹브라우저 상단의 도구 &gt;인터넷옵션 &gt;개인정보 메뉴의 옵션 설정을 통해 쿠키 저장을 거부할 수 있습니다.<br id="BR_163" />
                    ...
                    <div id="DIV_167">
                        ① 국립암센터(국가암데이터센터) K-CORE에서는 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다.
                    ...
                    <div id="DIV_189">
                        <p className='mb-2'>① 국립암센터(국가암데이터센터) K-OCRE는 계약업체에 대하여 개인정보보호법 제26조(업무위탁에 따른 개인정보의 처리 제한)에 따라 다음과 같이 개인정보 처리 업무를 위탁하고 있습니다. </p>
                        <table id="TABLE_191">
                        ...
                        <p>  ② 국립암센터(국가암데이터센터) K-CORE에서는 ①항에 따른 개인정보의 처리 제한에 대해 다음 내용을 포함한 문서에 의하여 처리하고 있습니다.  </p>  <br
                            id="BR_218" />
                        <ul className='m-4'>
                            <li >
                    ...
                    <div id="DIV_229" className='ms-4'>                  <br
                        id="BR_230" />
                        <ul className='m-4'>
                    ...
                    <div id="DIV_288">
                        ...
                        <ul className='m-5'>
                            ...
                            <li >
                                <a href={Attachments} download className='text-blue-300'> [첨부 1] 개인정보열람_정정_삭제_처리요구서</a>
                            </li>
                        </ul>
                        <span id="SPAN_284">
                        </span>
                    ...
                    <div id="DIV_307" className='m-5'>
                        ...
                        <p>② 국립암센터(국가암데이터센터) K-CORE를 이용하시면서 발생한 모든 개인정보보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 국가암데이터센터 개인정보보호 담당, 개인정보 보호책임자 및 실무담당자에게 문의하실 수 있습니다. 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.</p>
                    </div>
                    ...
                    <div id="DIV_357">
                        ...
                        <button className='bg-blue-500 hover:bg-blue-700 text-white h-12 font-bold py-2 px-8 mx-8 border border-blue-700 rounded'>이전 개인정보처리방침 2022. 09. 30</button>
                        </Link>
                    </div>
                </div>
