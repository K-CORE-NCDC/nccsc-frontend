                ...
                <div id="DIV_2" className="">
                  <div id="DIV_52">
                    ...
                    <p className="MarginTop10">
                      국립암센터 국가암데이터센터 내에서 운영하고 있는 K-CORE 포털은 ｢개인정보
                      ...
                      <div className="div_64_box">
                        ...
                        <div className="div_64_box_div">
                          <img
                            ...
                            className="div_64_box_img"
                          />
                          <span className="div_64_box_text">열람청구</span>
                        </div>
                        <div className="div_64_box_div">
                          <img
                    ...
                    <div className="div_64 MarginTop10" style={{ padding: '2%' }}>
                      <span>
                        ...
                        개인정보는「개인정보보호법」제15조(개인정보의 수집ㆍ이용)에 따라서 관련
                      ...
                      <div className="MarginTop10">
                        <table className="ktable">
                          ...
                          <tbody>
                            <tr>
                              <th className="kth">구분</th>
                              <th className="kth">처리목적 및 관련 근거</th>
                              <th className="kth">개인정보 항목</th>
                              <th className="kth">보유기간</th>
                            </tr>
                            <tr>
                              <td className="ktd">K-CORE portal 회원정보</td>
                              <td className="ktd">
                                개인정보보호법
                                <br />
                                제15조 제1항
                              ...
                              <td className="ktd">
                                ...
                                소속정보(정부(공공)기관, 대학, 연구소, 의료기관, 산업체, 기타),
                                접속정보
                              </td>
                              <td className="ktd">2년 회원탈퇴시 즉시 삭제</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                      <p className="MarginTop10">
                        ② 국립암센터(국가암데이터센터) K-CORE에서 처리하고 있는 개인정보 관련 법률은
                        「암관리법 제9조의2(암데이터사업)」 및 「개인정보 보호법」 제15조(개인정보의
                        수집ㆍ이용) 제1항 제2호,「개인정보 보호법」 제28조의2(가명정보의 처리 등)에
                        따라서 개인정보 보호 규정을 준수하여 처리하고 있습니다.
                      </p>
                      <p className="MarginTop10">
                        ③ 국립암센터(국가암데이터센터) K-CORE에서 운용하고 있는 개인정보는 특정
                        개인을 알아보기 위하여 사용될 수 있는 정보를 포함하지 않으며, 개인을 알아볼
                        수 있는 정보가 생성된 경우에는 즉시 해당 정보의 처리를 중지하고, 지체 없이
                        회수ㆍ파기하고 있습니다.
                      </p>
                    </div>
                    ...
                    <h5 id="" className="flex m-5">
                      <span id="SPAN_158">
                        제2조인터넷 접속정보파일 등 개인정보를 자동으로 수집하는 장치의 설치·운영 및
                        그 거부에 관한 사항{' '}
                      </span>
                    ...
                    <div className="div_64" style={{ padding: '2%' }}>
                      <p className="MarginTop10">
                        ① 국립암센터(국가암데이터센터) K-CORE에서 서비스 이용 과정 시 IP주소, 쿠키,
                        방문 일시·불량 이용 기록 등의 서비스 이용 기록이 생성되어 수집될 수
                        있습니다.{' '}
                      </p>
                      <p className="MarginTop10">
                        {' '}
                        ② 서비스 이용 과정에서 이용자에 관한 정보를 자동화된 방법으로 생성하여 이를
                        저장(수집)하거나, 이용자 기기의 고유한 정보를 원래의 값을 확인하지 못하도록
                        안전하게 변환한 후에 수집합니다.{' '}
                      </p>
                      <p className="MarginTop10">
                        ③ ③ 쿠키의 설치·운영 및 거부 방법은 웹브라우저 상단의 도구 &gt;인터넷옵션
                        &gt;개인정보 메뉴의 옵션 설정을 통해 쿠키 저장을 거부할 수 있습니다.{' '}
                      </p>
                      <p className="MarginTop10">
                        {' '}
                        ④ 쿠키 저장을 거부할 경우 웹서비스 이용에 어려움이 발생할 수 있습니다.
                      </p>
                    </div>
                    ...
                    <div className="div_64" style={{ padding: '2%' }}>
                      <p className="MarginTop10">
                        ① 국립암센터(국가암데이터센터) K-CORE에서는 개인정보 처리목적이 달성된
                      ...
                      <ul className="MarginTop10">
                        <li className="MarginTop10">
                          ...
                          <ul>
                            <li>
                              - 개인정보의 보유기간이 경과하거나, 개인정보의 이용 목적 달성 등 그
                              개인정보가 불필요하게 되었을 때에는 내부 방침 및 관련 법령에 따라
                    ...
                    <h5 className="flex m-5">
                      <span id="SPAN_187">제4조(개인정보처리 위탁에 관한 사항) </span>
                      <img src={processingconsignment} alt="처리위탁" id="IMG_188" />
                    </h5>

                    <div className="div_64 " style={{ padding: '2%' }}>
                      <p className="MarginTop10">
                        ① 국립암센터(국가암데이터센터) K-OCRE는 계약업체에 대하여 개인정보보호법
                        제26조(업무위탁에 따른 개인정보의 처리 제한)에 따라 다음과 같이 개인정보
                        처리 업무를 위탁하고 있습니다.
                      </p>
                      ...
                      <div className="MarginTop10">
                        <table className="ktable">
                          <tbody>
                            <tr>
                              <th className="kth">위탁업체</th>
                              <th className="kth">위탁업무 내용</th>
                              <th className="kth">위탁 개인정보</th>
                              <th className="kth">위탁기간</th>
                              <th className="kth">수탁업체 관리감독 결과</th>
                            </tr>
                            <tr>
                              <td className="ktd">㈜3BIGS</td>
                      ...
                      <p className="MarginTop10">
                        {' '}
                        ② 국립암센터(국가암데이터센터) K-CORE에서는 ①항에 따른 개인정보의 처리
                        제한에 대해 다음 내용을 포함한 문서에 의하여 처리하고 있습니다.{' '}
                      </p>
                      <ul className="">
                        <li className="MarginTop10">
                          - 위탁업무 수행 목적 외 개인정보의 처리 금지에 관한 사항
                        </li>
                        <li className="MarginTop10">- 개인(가명)정보의 안전관리에 관한 사항</li>
                        <li className="MarginTop10">
                          - 개인(가명)정보의 관리적·기술적 보호조치에 관한 사항
                        </li>
                        <li className="MarginTop10">
                          - 위탁업무의 목적 및 범위, 재위탁 제한에 관한 사항, 개인(가명)정보 안전성
                          확보 조치에 관한 사항, 위탁업무와 관련하여 보유하고 있는 개인(가명)정보의
                    ...
                    <h5 className="flex m-5">
                      <span id="SPAN_227">제5조 개인정보 안전성 확보조치 </span>
                    ...
                    <div className="div_64" style={{ padding: '2%' }}>
                      <p className="MarginTop10">
                        ① 국립암센터(국가암데이터센터)
                        K-CORE에서는「개인정보보호법」제29조(안전조치의무)항목에 의해 개인정보
                        안전성 확보에 관한 기술적·관리적·물리적 조치를 취하고 있습니다.
                      </p>
                      <ul>
                        <li className="MarginTop10">
                          1. 관리적 보호조치: 국립암센터는「개인정보 보호 기본지침」및 개인정보보호
                          종합 추진계획을 통하여 다음 사항이 포함된 내부관리계획을 수립·시행하고
                          있습니다.
                        </li>
                        <ul>
                          <li className="MarginTop10">
                        ...
                        <li className="MarginTop10">2. 기술적 보호조치</li>
                        <ul>
                          <li className="MarginTop10">- 접근권한 관리에 관한 사항</li>
                          <li>- 접근통제에 관한 사항</li>
                          <li>- 개인정보의 암호화 조치에 관한 사항</li>
                          <li>- 접속기록 보관 및 점검에 관한 사항</li>
                          <li>- 악성프로그램 등 방지에 관한 사항</li>
                        </ul>
                        <li className="MarginTop10">3. 물리적 보호조치 </li>
                        <ul className="MarginTop10">
                          <li className="">- 물리적 안전조치에 관한 사항</li>
                        </ul>
                      </ul>
                    </div>
                    ...
                    <h5 className="flex m-5">
                      <span id="SPAN_227">
                        제6조 정보주체와 법정대리인의 권리·의무 및 그 행사법{' '}
                      </span>
                      <img src={Measurestoensuresafety} alt="안전성확보조치" id="IMG_228" />
                    </h5>
                    ...
                    <div className="div_64" style={{ padding: '2%' }}>
                      <ul className="">
                        ...
                        <li className="MarginTop10">
                          1. 개인정보 열람 요구 : 보유하고 있는
                          개인정보파일은「개인정보보호법」제35조(개인정보의 열람)에 따라 열람을
                          요구할 수 있습니다. 다만, 개인정보 열람 요구 시 법 제35조 5항에 의하여
                          다음과 같이 제한될 수 있습니다.
                        </li>
                        <ul className="">
                          <li className="MarginTop10">
                            ...
                            <ul>
                              ...
                              <li>
                                - 공공기관이 다음 각 목의 어느 하나에 해당하는 업무를 수행할 때
                                중대한 지장을 초래하는 경우
                              </li>
                              <li>
                                - 공공기관이 다음 각 목의 어느 하나에 해당하는 업무를 수행할 때
                        ...
                        <li className="MarginTop10">
                          2. 개인정보 정정·삭제 요구 : 보유하고 있는
                          개인정보파일은「개인정보보호법」제36조(개인정보의 정정·삭제)에 따라
                          정정·삭제를 요구할 수 있습니다. 다만, 다른 법령에서 그 개인정보가 수집
                          대상으로 명시되어 있는 경우에는 그 삭제를 요구할 수 없습니다.
                        </li>

                        <li className="MarginTop10">
                          3. 개인정보 처리정지 요구 : 보유하고 있는 개인정보파일은
                          「개인정보보호법」제37조(개인정보의 처리정지 등)에 따라 처리정지를 요구할
                          수 있습니다. 다만, 개인정보 처리정지 요구 시 법 제37조 제2항에 의하여
                          처리정지 요구를 거절할 수 있습니다.{' '}
                        </li>
                        <ul className="">
                          <li>
                    ...
                    <div className="div_64" style={{ padding: '2%' }}>
                      <p>
                        {' '}
                        ① 정보주체는 개인정보보호법 제35조에 따른 개인정보의 열람청구를 아래의
                        부서에 할 수 있습니다. 정보주체의 개인정보 열람청구가 신속하게 처리되도록
                        하겠습니다.{' '}
                      </p>
                      <ul className="MarginTop10">
                        <li>- 부서명 : 데이터운영팀</li>
                    ...
                    <div className="div_64" style={{ padding: '2%' }}>
                      ...
                      <p className="MarginTop10">
                        ② 「개인정보보호법」제35조(개인정보의 열람), 제37조(개인정보의 처리정지
                        등)의 규정에 의한 정보주체의 요구에 대하여 공공기관의 장이 행한 처분 또는
                        부작위로 인하여 권리 또는 이익의 침해를 받은 정보주체는 행정심판법이 정하는
                        바에 따라 행정심판을 청구할 수 있습니다.
                      </p>
                      <p className="MarginTop10">
                        ※ 행정심판에 대해 자세한 사항은 행정심판위원회(http://www.simpan.go.kr)
                        홈페이지를 참고하시기 바랍니다.{' '}
                      </p>
                    </div>
                    ...
                    <div className="div_64 MarginTop10" style={{ padding: '2%' }}>
                        ...
                        <table className="">
                          <tbody className="ktable">
                            <tr>
                              ...
                              <th className="kth">담당자</th>
                              <th className="kth">부서명</th>
                              <th className="kth">연락처</th>
                            </tr>
                            <tr>
                              <td className="ktd">
                                <ul>
                            ...
                            <tr>
                              ...
                              <td className="ktd">김도엽</td>
                              <td className="ktd">암빅데이터센터</td>
                              <td className="ktd">
                                <ul>
                                  <li>- 전화번호 : 031-920-0774</li>
                                  <li>- 이메일: kimdy@ncc.re.kr</li>
                                </ul>
                              </td>
                            </tr>
                          </tbody>
                      ...
                      <p className="MarginTop10">
                        ...
                        개인정보보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 국가암데이터센터
                        개인정보보호 담당, 개인정보 보호책임자 및 실무담당자에게 문의하실 수
                        있습니다. 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
                      </p>
                    </div>
                    ...
                    <div className="div_64" style={{ padding: '2%' }}>
                      <p>
                        ① 이 개인정보 처리방침은 2022. 09. 30.부터 적용됩니다. 이전의 개인정보
                        처리방침은 아래에서 확인할 수 있습니다.
                      </p>
                      <span style={{ display: 'flex', justifyContent: 'flex-end' }}>
                        <Link className="capitalize" to="/oldprivacypolicy">
                          <button className="btn btnPrimary" style={{ borderRadius: '25px' }}>
                            이전 개인정보처리방침 2022. 09. 30
                          </button>
                        </Link>
                      </span>
                    </div>
