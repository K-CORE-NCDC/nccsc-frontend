export const homeConstants = {
  ...
  SINGLE_USERDATA_VISUALIZATION: 'SINGLE_USERDATA_VISUALIZATION',
  MULTI_USERDATA_VISUALIZATION: 'MULTI_USERDATA_VISUALIZATION',
  ...
  CLEAR_SINGLE_USER_DATA_VISUALIZATION: 'CLEAR_SINGLE_USER_DATA_VISUALIZATION',
  CLEAR_MULTI_USER_DATA_VISUALIZATION: 'CLEAR_MULTI_USER_DATA_VISUALIZATION',
  ...
  VCFMAF: 'VCFMAF',
  MAFMERGER: 'MAFMERGER',
  REFVERCONVERTER:'REFVERCONVERTER',
  LOGMANAGEMENT: 'LOGMANAGEMENT',
  SENDLOGMANAGEMENT: 'SENDLOGMANAGEMENT',
  CHECK_MOBILE: 'CHECK_MOBILE',
  CLEAR_NOTICE_DETAILS: 'CLEAR_NOTICE_DETAILS',
  CLEARTOOLSDATA:'CLEARTOOLSDATA',
  DATAFRAME_RECON:'DATAFRAME_RECON',
  CLEARMAFMERGER:'CLEARMAFMERGER',
