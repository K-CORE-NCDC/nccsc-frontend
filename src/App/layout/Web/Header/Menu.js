...
const MultipleElem = ({ elem, ind }) => {
  return (
    ...
    >
      ...
      <div
        className="text-base sm:text-sm md:text-md lg:text-base xl:text-xl  2xl:text-md z-50 float-left py-2 list-none text-left rounded shadow-lg mt-1 abc "
  ...
  const m = item.map((ele, index) => {
    if (ele.type === 'item') {
      ...
      return (
        <a
          key="admin_button"
          className="px-3 py-4 lg:py-2 flex text-base sm:text-sm md:text-md lg:text-base xl:text-xl  2xl:text-md"
