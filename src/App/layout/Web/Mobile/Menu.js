...
const MultipleElem = ({ elem, ind }) => {
  return (
    <li className="sidebar-dropdown" id={'multi_' + ind} onClick={addActiveClass}>
      ...
      <div
        className="text-base z-50 float-left py-2 list-none text-left rounded shadow-lg mt-1"
        id={'multisubmenu_' + ind}
      >
  ...
  return (
    <>
      ...
      <div className="relative inline-flex">
        <svg
          className="w-5 h-5 absolute top-0 right-0 m-8 pointer-events-none"
        ...
        <select
          ...
          className="w-80 border border-white rounded bg-transparent text-white h-20 pl-5 pr-5 focus:tex-black active:tex-black hover:border-gray-400 focus:outline-none appearance-none"
        >
